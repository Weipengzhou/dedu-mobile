...
class Index extends React.Component{
  ...
  onSubmit(){
    var data = {name:this.state.name,phone:this.state.phone,type:this.state.kind}
    if(this.state.name === ''){
          this.setState({
              nameOn:true,
              })
          ...
          <div className='Index'>
            ...
            <div className={this.state.isModalOpen? "on model": "off model"}>
                ...
                <div className="to">
                    ...
                    <h2>填写预约信息<span>(提交后我们会尽快联系您)</span></h2>
                      <Button type='text' placeholder='请输入您的称呼' className={this.state.nameOn? "ono name": "name"} name='name' onChange={this.onChange}/>
                      <Button type="phone" placeholder='请输入您的联系电话' className={this.state.phoneOn? "ono phone": "phone"} name='phone' onChange={this.onChange}/>
                      <Button type='text' placeholder='请输入您的项目类型' className={this.state.kindOn? "ono kind": "kind"} name='kind' onChange={this.onChange}/>
